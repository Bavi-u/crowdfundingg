    ...
    return (
        ...
        <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
         ...
         <div className="relative p-6 flex-auto">
            <p className="my-4 text-slate-500 text-lg leading-related">
               {donate.description} 
                </p> 
                ...
                required
                type="text"
                className="flex-grow w-full h-12 px-4 mb-2 ransaction duration-200 bg-white border border-gray-300 rounded shadow-sm appearence-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                id="firstName"
                name="firstName"
                />
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                    ...
                    <button 
                    className="background text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"
                    type="button"
